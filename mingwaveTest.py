...
from model import WT, AR_MA, NonlinReg, ModelEvaluation,WT_DWT
import datetime
...
df["dwt_close_cA"],df["dwt_close_c"] =WT_DWT(df['Close'], plot=False)
...
apdict = [mpf.make_addplot(df['coeff_close'],width=4, color='r'),
        #mpf.make_addplot(df['coeff_high']),
        #mpf.make_addplot(df['coeff_low']),
        mpf.make_addplot(df['coeff_close_01']),
        mpf.make_addplot(df['dwt_close_cA'],width=4, color='b'),
